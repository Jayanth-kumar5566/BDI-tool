    ...
    mainPanel(
      tabsetPanel(
        ...
        tabPanel("Help",
                 ...
                 p("For detailed description on how to use the tool, see",
                  tags$a("here", href = "https://github.com/Jayanth-kumar5566/BDI-tool/blob/main/SHINY_APP_INSTRUCTIONS.md", target = "_blank"),
                  "."),
                 hr(),
